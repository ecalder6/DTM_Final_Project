...
ECHO "twitter_vae"
REM python train.py --cov_path=analytics/twitter_vae --use_mutual=False --use_vae=True --use_highway=False --kl_anneal=False --use_checkpoint=False --task=twitter --iterations=2000 --output_file=../data/outputs/twitter_vae.txt
...
REM python train.py --cov_path=analytics/twitter_vae_highway --use_mutual=False --use_vae=True --use_highway=True --kl_anneal=False --use_checkpoint=False --task=twitter --iterations=2000 --output_file=../data/outputs/twitter_vae_highway.txt

ECHO "twitter_vae_highway_anneal"
REM python train.py --cov_path=analytics/twitter_vae_highway_anneal --use_mutual=False --use_vae=True --use_highway=True --kl_anneal=True --use_checkpoint=False --task=twitter --iterations=2000 --output_file=../data/outputs/twitter_vae_highway_anneal.txt
...
ECHO "movie_seq2seq"
REM python train.py --cov_path=analytics/movie_seq2seq --use_mutual=False --use_vae=False --use_highway=False --kl_anneal=False --use_checkpoint=False --task=movie --iterations=2000 --output_file=../data/outputs/movie_seq2seq.txt
